export const site = {
  name: "Plembfin",
  title: "Plembfin - The local brain for your media stack.",
  description:
  ...
  support: "https://github.com/sponsors/Lasikiewicz",
...
export const features = [
  ...
  },
  {
    ...
    text: "Review provider watched flags without reliable completion times by item or show, choose a date policy, or dismiss them safely.",
  },
  {
...
export const featureStories = [
  ...
  },
  {
    ...
    text: "See live playback, the next movie or episode worth starting, recently watched TV and movies, upcoming episodes, and long-term viewing patterns in one focused app.",
    bullets: ["Now Playing refreshes within seconds", "Mixed Up Next with provider availability and Watch Now links", "History, calendar, and useful statistics"],
  ...
  },
  {
    ...
    bullets: ["Save movies and shows for later", "Rate movies, shows, and episodes from one to ten", "Create lists for any collection you want to keep"],
    ...
    link: "/docs/watchlist/",
    linkLabel: "Open the Watchlist guide",
  },
  {
    id: "ownership",
...
export const docsNav = [
  {
    label: "Start here",
    description: "Get a new instance ready and choose the right next guide.",
    items: [
      {
        slug: "guides",
        label: "Guides",
        description: "Choose a focused path for setup, daily use, connections, maintenance, or recovery.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        slug: "libraries",
        label: "Shared library controls",
        description: "Controls shared by the Movies and TV Shows libraries.",
        children: [
          { id: "shared-library-controls", label: "Shared library controls" },
          { id: "the-shared-card-controls", label: "The shared card controls" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        slug: "watchlist",
        label: "Watchlist",
        description: "Save movies and shows for later.",
        children: [
    ...
    items: [
      {
        ...
        children: [
          ...
          { id: "up-next-resume-progress-is-missing-or-wrong", label: "Up Next resume progress is missing or wrong" },
...
export const docsSidebarNav = [
  ...
  { id: "watchlist", label: "Watchlist", slug: "watchlist" },
  { id: "ratings", label: "Ratings", slug: "ratings" },
  { id: "custom-lists", label: "Custom Lists", slug: "custom-lists" },
...
export const docsPageNav = [
  ...
  { slug: "ratings", label: "Ratings" },
  { slug: "custom-lists", label: "Custom Lists" },
  { slug: "history-search", label: "History" },
