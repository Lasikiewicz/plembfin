...
IMAGE="${1:?Usage: deploy-oracle-demo.sh IMAGE CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
CONTAINER_NAME="${2:?Usage: deploy-oracle-demo.sh IMAGE CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
DATA_DIR="${3:?Usage: deploy-oracle-demo.sh IMAGE CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
HOST_PORT="${4:?Usage: deploy-oracle-demo.sh IMAGE CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
RUNTIME="${5:?Usage: deploy-oracle-demo.sh IMAGE CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
TRAKS_SCRIPT_URL="${6:-}"
TRAKS_SITE_KEY="${7:-}"
