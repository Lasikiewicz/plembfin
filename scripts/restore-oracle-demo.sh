...
CONTAINER_NAME="${1:?Usage: restore-oracle-demo.sh CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
DATA_DIR="${2:?Usage: restore-oracle-demo.sh CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
HOST_PORT="${3:?Usage: restore-oracle-demo.sh CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
RUNTIME="${4:?Usage: restore-oracle-demo.sh CONTAINER_NAME DATA_DIR HOST_PORT RUNTIME [TRAKS_SCRIPT_URL] [TRAKS_SITE_KEY] [TRAKS_REQUIRE_CONSENT] [GA_MEASUREMENT_ID] [GA_REQUIRE_CONSENT]}"
TRAKS_SCRIPT_URL="${5:-}"
TRAKS_SITE_KEY="${6:-}"
