...
// trigger, which is routinely one of the bot's own noise commits (a build
// bump or a merge) rather than real work. Fall back to the most recent real
// commit in this push's range for the entry's headline instead, same as the
