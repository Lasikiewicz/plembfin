...
| --- | --- | --- | --- |
| Admin username + password | Dashboard login | scrypt hash in `data/config.json` (`ADMIN_USERNAME`/`ADMIN_PASSWORD` env override until credentials are managed in-app) | Settings → General → Account |
