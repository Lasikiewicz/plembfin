import { readStoredAdminToken } from "./auth.js?v=1.1.1.4.0";
import { readStoredDebugLogs } from "./logs.js?v=1.1.1.4.0";
import { isDemoMode } from "./utils.js?v=1.1.1.4.0";
...
const initialState = {
  ...
  syncActivityProgress: { total: 0, completed: 0, active: false, label: "", currentItemLabel: "", startupScanActive: false },
  syncActivityPaused: false,
  syncAttention: [],
