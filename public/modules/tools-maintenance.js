...
import { escapeHtml, escapeAttribute, platformName, formatDate, formatNumber } from "./utils.js?v=1.1.1.0.1";
import { categorizeIssues } from "./sync.js?v=1.1.1.0.1";
import { openFixMatchDialog } from "./edit-dialogs.js?v=1.1.1.0.1";
