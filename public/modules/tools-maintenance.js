...
import { escapeHtml, escapeAttribute, platformName, formatDate, formatNumber } from "./utils.js?v=0.16.3.1";
import { categorizeIssues } from "./sync.js?v=0.16.3.1";
import { openFixMatchDialog } from "./edit-dialogs.js?v=0.16.3.1";
