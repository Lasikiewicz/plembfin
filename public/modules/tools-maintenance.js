...
import { escapeHtml, escapeAttribute, platformName, formatDate, formatNumber } from "./utils.js?v=0.16.3.3";
import { categorizeIssues } from "./sync.js?v=0.16.3.3";
import { openFixMatchDialog } from "./edit-dialogs.js?v=0.16.3.3";
