...
import { escapeHtml, escapeAttribute, platformName, formatDate, formatNumber } from "./utils.js?v=0.15.0.9";
import { categorizeIssues } from "./sync.js?v=0.15.0.9";
import { openFixMatchDialog } from "./edit-dialogs.js?v=0.15.0.9";
