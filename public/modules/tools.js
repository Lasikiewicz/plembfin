...
import { escapeHtml, escapeAttribute, formatNumber, formatDate, csvRows, normalizeHeader, episodeCode } from "./utils.js?v=1.2.2.0.15";
import { initBackupTools } from "./tools-backups.js?v=1.2.2.0.15";
import { initMaintenanceTools } from "./tools-maintenance.js?v=1.2.2.0.15";
import { initHealthTools } from "./tools-health.js?v=1.2.2.0.15";
import { initDuplicateWatchTools } from "./tools-duplicates.js?v=1.2.2.0.15";
import { initWipeDataTools } from "./tools-wipe-data.js?v=1.2.2.0.15";
import { initPlaystateAliasTools } from "./tools-playstate-aliases.js?v=1.2.2.0.15";
...
export function initTools(callbacks) {
  ...
  initPlaystateAliasTools(callbacks);
}
...
export {
  ...
  createPlembfinBackupRemoteNow,
  createRemoteWatchBackupNow,
  ...
  loadRemotePlembfinBackupsForRestoreTab,
  loadWatchBackups,
  ...
  restoreRemotePlembfinBackup,
  restoreWatchBackup,
  saveAppearanceSettings,
  savePlembfinBackupRemoteSettings,
  savePlembfinBackupSettings,
  saveRemoteWatchBackupSettings,
  saveWatchBackupSettings,
  setBackupTransferState,
  updatePlembfinButtonsState,
  uploadWatchBackupFile,
} from "./tools-backups.js?v=1.2.2.0.15";
export { APPEARANCE_DEFAULTS, applyAppearanceToBody, loadAppearanceSettings } from "./appearance.js?v=1.2.2.0.15";
export { loadCacheStats, renderCachePanel, resetFullSyncWatchstates } from "./tools-maintenance.js?v=1.2.2.0.15";
export { loadSyncHealth } from "./tools-health.js?v=1.2.2.0.15";
// ── Trakt / CSV import ─────────────────────────────────────────────────────
...
// re-exported here so existing imports of these names from "./tools.js?v=1.2.2.0.15"
// keep working unchanged.
export { runRepairWorkflow, runPhantomWatchAudit, runPhantomWatchRepair, runTraktBackfill, runRematchTvShows, runFullSyncWatchstates, cancelFullSyncWatchstates, runSystemIntegrityCheck, triggerClearMissingTelemetry, triggerRetryAllCategory } from "./tools-maintenance.js?v=1.2.2.0.15";
export { runDuplicateWatchCleanup } from "./tools-duplicates.js?v=1.2.2.0.15";
export { runEpisodeTitleAudit, runEpisodeTitleBackfill } from "./tools-maintenance.js?v=1.2.2.0.15";
export { loadWipeDataPreview, runWipeData } from "./tools-wipe-data.js?v=1.2.2.0.15";
