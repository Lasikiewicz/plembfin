...
import { escapeHtml, escapeAttribute, slug, formatTmdbDate, tvShowTmdbHref, movieTmdbHref, platformIconUrl, isDemoMode } from "./utils.js?v=1.1.0.0.3";
import { tmdbImage, tmdbPoster, tmdbProfile } from "./images.js?v=1.1.0.0.3";
import { fetchTmdbDetails } from "./tmdb.js?v=1.1.0.0.3";
      ...
      : `
        <b class="media-app-link-row">
          <a class="media-app-link media-app-link--plex media-app-link--disabled" title="Checking Plex..." aria-label="Checking Plex..." style="opacity: 0.4; cursor: not-allowed;">
            <img class="media-app-link-logo" src="/icons/plex.svg?v=1.1.0.0.3" alt="" loading="eager" decoding="async" data-err="hide-show-next" />
            <span>Plex</span>
          </a>
          <a class="media-app-link media-app-link--emby media-app-link--disabled" title="Checking Emby..." aria-label="Checking Emby..." style="opacity: 0.4; cursor: not-allowed;">
            <img class="media-app-link-logo" src="/icons/emby.svg?v=1.1.0.0.3" alt="" loading="eager" decoding="async" data-err="hide-show-next" />
            <span>Emby</span>
          </a>
          <a class="media-app-link media-app-link--jellyfin media-app-link--disabled" title="Checking Jellyfin..." aria-label="Checking Jellyfin..." style="opacity: 0.4; cursor: not-allowed;">
            <img class="media-app-link-logo" src="/icons/jellyfin.svg?v=1.1.0.0.3" alt="" loading="eager" decoding="async" data-err="hide-show-next" />
            <span>Jellyfin</span>
          </a>
        </b>
      `;
...
const RATING_SOURCE_ICONS = { TMDB: "/icons/tmdb.svg?v=1.1.0.0.3", TVDB: "/icons/tvdb.svg?v=1.1.0.0.3", IMDb: "/icons/imdb.svg?v=1.1.0.0.3" };
