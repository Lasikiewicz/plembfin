...
import { escapeHtml, escapeAttribute, formatDate, slug, movieHref, movieTmdbHref, tvShowTmdbHref, tvShowTvdbHref, showTitleFrom, platformIconMarkup } from "./utils.js?v=0.15.0.14";
import { syncHistoryTone, syncHistoryActionLabel } from "./sync.js?v=0.15.0.14";
...
const PLATFORMS = {
  plex: { name: "Plex", icon: "/icons/plex.svg?v=0.15.0.14" },
  emby: { name: "Emby", icon: "/icons/emby.svg?v=0.15.0.14" },
  jellyfin: { name: "Jellyfin", icon: "/icons/jellyfin.svg?v=0.15.0.14" },
  trakt: { name: "Trakt", icon: "/icons/trakt.svg?v=0.15.0.14" },
