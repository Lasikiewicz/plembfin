...
import { escapeHtml, escapeAttribute, formatDate, slug, movieHref, movieTmdbHref, tvShowTmdbHref, tvShowTvdbHref, showTitleFrom, platformName, platformIconMarkup } from "./utils.js?v=1.2.2.0.15";
import { syncHistoryTone, syncHistoryActionLabel } from "./sync.js?v=1.2.2.0.15";
...
const PLATFORMS = {
  plex: { name: "Plex", icon: "/icons/plex.svg?v=1.2.2.0.15" },
  emby: { name: "Emby", icon: "/icons/emby.svg?v=1.2.2.0.15" },
  jellyfin: { name: "Jellyfin", icon: "/icons/jellyfin.svg?v=1.2.2.0.15" },
  trakt: { name: "Trakt", icon: "/icons/trakt.svg?v=1.2.2.0.15" },
