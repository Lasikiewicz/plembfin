...
import { escapeHtml, escapeAttribute, formatDate, slug, movieHref, movieTmdbHref, tvShowTmdbHref, tvShowTvdbHref, showTitleFrom, platformName, platformIconMarkup } from "./utils.js?v=1.1.1.5.1";
import { syncHistoryTone, syncHistoryActionLabel } from "./sync.js?v=1.1.1.5.1";
...
const PLATFORMS = {
  plex: { name: "Plex", icon: "/icons/plex.svg?v=1.1.1.5.1" },
  emby: { name: "Emby", icon: "/icons/emby.svg?v=1.1.1.5.1" },
  jellyfin: { name: "Jellyfin", icon: "/icons/jellyfin.svg?v=1.1.1.5.1" },
  trakt: { name: "Trakt", icon: "/icons/trakt.svg?v=1.1.1.5.1" },
