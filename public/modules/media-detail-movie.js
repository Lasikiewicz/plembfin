...
import { escapeHtml, escapeAttribute, formatDate, formatTmdbDate } from "./utils.js?v=0.15.0.16";
import { posterUrlFor, tmdbPoster, bestTmdbLogo, proxiedArtworkUrl, hydratePosters } from "./images.js?v=0.15.0.16";
import { isWatchedHistoryAction, getMediaTargetSyncStatus, renderSyncStatusDot } from "./sync.js?v=0.15.0.16";
import { fetchTmdbDetails } from "./tmdb.js?v=0.15.0.16";
import { renderWatchDatePrompt, isMovieSavingWatchAction } from "./watch-action.js?v=0.15.0.16";
import { authHeaders, mediaDetailRoot, mediaDetailLoaderHtml, setMediaDetailActions, mediaInfoActionHtml, mediaForceSyncActionHtml, mediaToolsActionHtml, setMediaInfoContext, bumpMediaRenderToken, currentMediaRenderToken } from "./media-detail-context.js?v=0.15.0.16";
import { personalRatingPillHtml, personalMediaActionsHtml } from "./personal-media.js?v=0.15.0.16";
import {
