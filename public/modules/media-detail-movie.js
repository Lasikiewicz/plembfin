...
import { escapeHtml, escapeAttribute, formatDate, formatTmdbDate } from "./utils.js?v=0.16.3.1";
import { posterUrlFor, tmdbPoster, bestTmdbLogo, proxiedArtworkUrl, hydratePosters } from "./images.js?v=0.16.3.1";
import { isWatchedHistoryAction, getMediaTargetSyncStatus, renderSyncStatusDot } from "./sync.js?v=0.16.3.1";
import { fetchTmdbDetails } from "./tmdb.js?v=0.16.3.1";
import { renderWatchDatePrompt, isMovieSavingWatchAction } from "./watch-action.js?v=0.16.3.1";
import { authHeaders, mediaDetailRoot, mediaDetailLoaderHtml, setMediaDetailActions, mediaInfoActionHtml, mediaForceSyncActionHtml, mediaToolsActionHtml, setMediaInfoContext, bumpMediaRenderToken, currentMediaRenderToken } from "./media-detail-context.js?v=0.16.3.1";
import { personalRatingPillHtml, personalMediaActionsHtml } from "./personal-media.js?v=0.16.3.1";
import {
