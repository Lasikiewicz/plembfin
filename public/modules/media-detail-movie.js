...
import { escapeHtml, escapeAttribute, formatDate, formatTmdbDate, isDemoMode } from "./utils.js?v=1.1.0.0.2";
import { posterUrlFor, tmdbImage, tmdbPoster, bestTmdbLogo, proxiedArtworkUrl, hydratePosters } from "./images.js?v=1.1.0.0.2";
import { isWatchedHistoryAction, getMediaTargetSyncStatus, renderSyncStatusDot } from "./sync.js?v=1.1.0.0.2";
import { fetchTmdbDetails } from "./tmdb.js?v=1.1.0.0.2";
import { renderWatchDatePrompt, isMovieSavingWatchAction } from "./watch-action.js?v=1.1.0.0.2";
import { authHeaders, mediaDetailRoot, mediaDetailLoaderHtml, setMediaDetailActions, mediaInfoActionHtml, mediaForceSyncActionHtml, mediaToolsActionHtml, setMediaInfoContext, bumpMediaRenderToken, currentMediaRenderToken } from "./media-detail-context.js?v=1.1.0.0.2";
import { personalRatingPillHtml, personalMediaActionsHtml } from "./personal-media.js?v=1.1.0.0.2";
import {
