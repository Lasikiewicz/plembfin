...
import { escapeHtml, escapeAttribute, isDemoMode } from "./utils.js?v=1.2.0.0.1";
import { openServiceEditModal } from "./settings-services.js?v=1.2.0.0.1";
import { embyWebhookSetup, jellyfinWebhookSetup, buildWebhookUrl } from "./help-content.js?v=1.2.0.0.1";
import { claimAdminAccount } from "./auth.js?v=1.2.0.0.1";
import { lazyExport } from "./route-modules.js?v=1.2.0.0.1";
import {
...
export function renderSetupPage() {
  ...
  const logoSrc = document.documentElement.classList.contains("light-mode") ? "/plembfin_header_logo_light.png?v=1.2.0.0.1" : "/plembfin_header_logo_dark.png?v=1.2.0.0.1";
  if (restoreView) {
