...
import { escapeHtml, escapeAttribute, isDemoMode } from "./utils.js?v=1.2.1.0.0";
import { openServiceEditModal } from "./settings-services.js?v=1.2.1.0.0";
import { embyWebhookSetup, jellyfinWebhookSetup, buildWebhookUrl } from "./help-content.js?v=1.2.1.0.0";
import { claimAdminAccount } from "./auth.js?v=1.2.1.0.0";
import { lazyExport } from "./route-modules.js?v=1.2.1.0.0";
import {
...
export function renderSetupPage() {
  ...
  const logoSrc = document.documentElement.classList.contains("light-mode") ? "/plembfin_header_logo_light.png?v=1.2.1.0.0" : "/plembfin_header_logo_dark.png?v=1.2.1.0.0";
  if (restoreView) {
