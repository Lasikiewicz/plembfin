import { HIDE_EPISODE_SPOILERS_KEY, state } from "./state.js?v=0.15.0.6";
import { escapeAttribute, formatDate, showTitleFrom, showName, slug, movieHref, movieTmdbHref, tvShowTmdbHref, tvShowTvdbHref } from "./utils.js?v=0.15.0.6";
import { isCachedStorageImageUrl, proxiedArtworkUrl, rememberPosterLookup } from "./images.js?v=0.15.0.6";
import {
  openEditDateDialog,
...
} from "./edit-dialogs.js?v=0.15.0.6";
import {
  openWatchDatePrompt,
...
} from "./watch-action.js?v=0.15.0.6";
import { triggerRetrySync, loadSyncJobs, loadSyncHistory, showAvailIssuePopup } from "./sync.js?v=0.15.0.6";
import { renderExplorer, renderHistoryView, resolvedTmdbCache, refreshMovieExplorerInPlace, refreshHistoryViewInPlace } from "./explorer.js?v=0.15.0.6";
import {
  movieBySlugOrId,
...
import { fetchWatchedMovieByTmdb, syncRewatchHistoryToggle } from "./media-detail-movie.js?v=0.15.0.6";
import { addToWatchlist, removeFromWatchlist, openAddToListDialog, personalItemFromDetailDataset, refreshRenderedPersonalMediaControls, loadPersonalMedia } from "./personal-media.js?v=0.15.0.6";
