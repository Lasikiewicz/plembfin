import { escapeHtml, escapeAttribute, platformName, formatDate, formatSeasonTitle } from "./utils.js?v=0.16.3.4";
import { normalizeTargetStatus, syncStatus, telemetryTargetStates } from "./sync.js?v=0.16.3.4";
