...
import { escapeHtml, escapeAttribute, formatNumber, formatDate } from "./utils.js?v=1.0.1.2";
import { openSettingsEditModal, openSettingsPickerModal, renderServiceCardGrid } from "./settings-ui.js?v=1.0.1.2";
...
export async function saveAppearanceSettings() {
  ...
  if (state.activeShowModalKey) {
    const { openShowInlineDetail, renderImmersiveShowModal } = await import("./media-detail-show.js?v=1.0.1.2");
    ...
    const { openMovieImmersiveModalByTmdbId, openMovieImmersiveModal } = await import("./media-detail-movie.js?v=1.0.1.2");
