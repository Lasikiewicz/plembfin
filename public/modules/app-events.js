...
import { fetchTmdbDetails, fetchTmdbSeasonDetails, resolveEpisodeTitleFromTmdb } from "./tmdb.js?v=20260803";
...
import { closePersonProfile, loadCastMemberDetails } from "./media-person.js?v=20260809";
import { initMediaLightbox } from "./media-lightbox.js";
import { initMediaDetailEvents, attachMediaDetailEvents } from "./media-detail-events.js?v=20260809";
...
function attachEvents() {
  ...
  if (elements.cancelFullSyncButton) {
    elements.cancelFullSyncButton.addEventListener("click", () => {
      cancelFullSyncWatchstates().catch(() => { });
    });
  }

  if (elements.resetFullSyncButton) {
    elements.resetFullSyncButton.addEventListener("click", () => {
      resetFullSyncWatchstates();
    });
  }
