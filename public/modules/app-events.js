...
import { initDashboard, getRowFitLimit, mediaRecordIdentity, dedupeMediaRecords, progressRecordIdentity, dedupePlaybackProgress, renderHistoryCard, observeDashboardPosters, renderDashboard, updateDashboardSplitState, resetPartWatchedView, renderPartWatchedCard, renderPartWatched } from "./dashboard.js?v=20260904a";
import { loadUpNext, removeUpNextItem, restoreUpNextItem } from "./up-next.js?v=20260904b";
...
import { closePersonProfile, loadCastMemberDetails } from "./media-person.js?v=20260903m";
import { initMediaLightbox } from "./media-lightbox.js";
import { initMediaDetailEvents, attachMediaDetailEvents, initLibraryForceSyncPanel } from "./media-detail-events.js?v=20260903m";
import { attachSidebarMiddleClickNavigation } from "./sidebar-navigation.js";
import { initPosterOverflowMenu, closePosterOverflowMenu, setPosterOverflowMenuActionPending } from "./poster-menu.js?v=20260831l";
