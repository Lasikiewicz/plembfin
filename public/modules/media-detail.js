...
import { slug, movieSlug, movieHref, movieTmdbHref, tvShowTmdbHref, showName, showTitleFrom } from "./utils.js?v=1.2.1.0.1";
...
} from "./media-detail-context.js?v=1.2.1.0.1";
import {
...
} from "./media-detail-show.js?v=1.2.1.0.1";
import {
  renderMovieImmersiveModalContent, openMovieImmersiveModalByTmdbId, patchMovieWatchedState, syncMovieWatchActionControls,
} from "./media-detail-movie.js?v=1.2.1.0.1";
import { fetchSeerrMediaStatus, refreshActiveMediaDetailAfterSeerrStatus } from "./media-detail-shared.js?v=1.2.1.0.1";
