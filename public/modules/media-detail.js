...
import { slug, movieSlug, movieHref, movieTmdbHref, tvShowTmdbHref, showName, showTitleFrom } from "./utils.js?v=1.2.2.0.15";
...
} from "./media-detail-context.js?v=1.2.2.0.15";
import {
...
} from "./media-detail-show.js?v=1.2.2.0.15";
import {
  renderMovieImmersiveModalContent, openMovieImmersiveModalByTmdbId, patchMovieWatchedState, syncMovieWatchActionControls,
} from "./media-detail-movie.js?v=1.2.2.0.15";
import { fetchSeerrMediaStatus, refreshActiveMediaDetailAfterSeerrStatus } from "./media-detail-shared.js?v=1.2.2.0.15";
