...
import { openSettingsEditModal, openSettingsPickerModal, renderFieldRow, collectFieldValues, renderInlineServicePanel } from "./settings-ui.js?v=1.2.0.0.2";
import { prepareHelpReadMore } from "./settings-shell.js?v=1.2.0.0.2";
...
import {
  ...
  savedCredentialNote,
} from "./help-content.js?v=1.2.0.0.2";
import {
