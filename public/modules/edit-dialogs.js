...
import { escapeHtml, escapeAttribute, slug, sanitizeTitle, showTitleFrom, formatDate, actualWatchHistory, sourceBadgeHtml, isDemoMode } from "./utils.js?v=1.0.0.3";
import { buildAuthHeaders } from "./auth.js?v=1.0.0.3";
import { isWatchedHistoryAction } from "./sync.js?v=1.0.0.3";
import { tmdbPoster, tmdbImage, proxiedArtworkUrl } from "./images.js?v=1.0.0.3";
import { dateAtMiddayIso, refreshShowAfterManualWatch, watchedAtForChoice, watchedReferenceFor } from "./watch-action.js?v=1.0.0.3";
