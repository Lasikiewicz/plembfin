...
import { escapeHtml, escapeAttribute, slug, sanitizeTitle, showTitleFrom, formatDate, actualWatchHistory, sourceBadgeHtml, isDemoMode, tvShowTvdbHref } from "./utils.js?v=1.1.1.9.0";
import { buildAuthHeaders } from "./auth.js?v=1.1.1.9.0";
import { isWatchedHistoryAction } from "./sync.js?v=1.1.1.9.0";
import { tmdbPoster, tmdbImage, proxiedArtworkUrl } from "./images.js?v=1.1.1.9.0";
import { dateAtMiddayIso, refreshShowAfterManualWatch, watchedAtForChoice, watchedReferenceFor } from "./watch-action.js?v=1.1.1.9.0";
