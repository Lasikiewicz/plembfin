...
import { escapeHtml, escapeAttribute, slug, sanitizeTitle, showTitleFrom, formatDate, actualWatchHistory, sourceBadgeHtml } from "./utils.js?v=0.16.1.0.0";
import { buildAuthHeaders } from "./auth.js?v=0.16.1.0.0";
import { isWatchedHistoryAction } from "./sync.js?v=0.16.1.0.0";
import { tmdbPoster, tmdbImage, proxiedArtworkUrl } from "./images.js?v=0.16.1.0.0";
import { dateAtMiddayIso, refreshShowAfterManualWatch, watchedAtForChoice, watchedReferenceFor } from "./watch-action.js?v=0.16.1.0.0";
