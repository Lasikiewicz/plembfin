...
import { escapeHtml, escapeAttribute, platformName, formatDate } from "./utils.js?v=1.1.1.0.1";
import { historyAction, syncStatus, telemetryLineValue } from "./sync.js?v=1.1.1.0.1";
import { syncInlineMediaDetailHeading } from "./explorer.js?v=1.1.1.0.1";
import { auditEventsForRecord, infoSyncSummary, infoSyncTargetStates, infoWatchDetails, mediaInfoGlanceEntries, renderInfoWatchSync } from "./media-info-summary.js?v=1.1.1.0.1";
