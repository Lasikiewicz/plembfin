...
function updateThemeIcon() {
  ...
  const src = isLightMode ? "/plembfin_header_logo_light.png?v=1.2.1.0.1" : "/plembfin_header_logo_dark.png?v=1.2.1.0.1";
