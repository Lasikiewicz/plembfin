...
function updateThemeIcon() {
  ...
  const src = isLightMode ? "/plembfin_header_logo_light.png?v=1.2.0.0.2" : "/plembfin_header_logo_dark.png?v=1.2.0.0.2";
