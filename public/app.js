...
import { initAppEvents, closeMobileMenu } from "./modules/app-events.js?v=1.0.2.0.0";
import { initTrackerSettings, refreshTrackerSettings } from "./modules/tracker-settings.js?v=1.0.2.0.0";
import { initRatingSyncSettings, applyRatingSyncConfig, refreshRatingSyncStatus, runRatingSyncNow } from "./modules/rating-sync-settings.js?v=1.0.2.0.0";
import { initWatchlistSyncSettings, applyWatchlistSyncConfig, refreshWatchlistSyncStatus, runWatchlistSyncNow } from "./modules/watchlist-sync-settings.js?v=1.0.2.0.0";
import { startLiveUpdates, stopLiveUpdates } from "./modules/live-updates.js?v=1.0.2.0.0";
import { initManualWatchReview, loadManualWatchReview, renderManualWatchReviewPage, renderManualWatchReviewSummary, startManualWatchReviewPolling, stopManualWatchReviewPolling } from "./modules/manual-watch-review.js?v=1.0.2.0.0";
