...
import { initMediaDetail, movieBySlugOrId, nowPlayingHref, openMovieInlineDetail, openShowInlineDetail, clearMediaDetailState, syncMediaActionsMenuState, syncTopbarControlsMenuState, closeDebugModal, closeMediaDetail, renderImmersiveShowModal, renderShowModalContent, patchShowModalEpisodeFromLive, patchShowModalEpisodesSavingState, renderMovieImmersiveModalContent, openMovieImmersiveModalByTmdbId, openShowImmersiveModalByTmdbId, openShowImmersiveModalByTvdbId, openHistoryDebugModal, fetchSeerrMediaStatus, refreshActiveMediaDetailAfterSeerrStatus, patchMovieWatchedState } from "./modules/media-detail.js?v=0.16.3.3";
import { applyLiveHistoryChanges, refreshActiveDetailView } from "./modules/media-detail-events.js?v=0.16.3.3";
import { initMediaPerson, closePersonProfile, loadCastMemberDetails } from "./modules/media-person.js?v=0.16.3.3";
import { initMediaLightbox } from "./modules/media-lightbox.js?v=0.16.3.3";
import { initAppEvents, closeMobileMenu } from "./modules/app-events.js?v=0.16.3.3";
import { initTrackerSettings, refreshTrackerSettings } from "./modules/tracker-settings.js?v=0.16.3.3";
import { initRatingSyncSettings, applyRatingSyncConfig, refreshRatingSyncStatus, runRatingSyncNow } from "./modules/rating-sync-settings.js?v=0.16.3.3";
import { initWatchlistSyncSettings, applyWatchlistSyncConfig, refreshWatchlistSyncStatus, runWatchlistSyncNow } from "./modules/watchlist-sync-settings.js?v=0.16.3.3";
import { startLiveUpdates, stopLiveUpdates } from "./modules/live-updates.js?v=0.16.3.3";
import { initManualWatchReview, loadManualWatchReview, renderManualWatchReviewPage, renderManualWatchReviewSummary, startManualWatchReviewPolling, stopManualWatchReviewPolling } from "./modules/manual-watch-review.js?v=0.16.3.3";
